...
def user_invited(requests_mock, context):
    ...
    assert return_value is True
    context['expected_message'] = "User test-username has already been invited to join github org. \
...
def add_user_to_org(requests_mock, context):
    ...
    return_value = helpers.put_user(username=user_name())
    assert return_value is True
    context['expected_message'] = "Invited user test-username to join github org. \
